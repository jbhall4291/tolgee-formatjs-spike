...
//     const language = tolgee.getLanguage(); // Get the currently selected language from Tolgee


//     const services = [
//         {
//             titleKeyEN: "service one title",
//             titleKeyES: "servico title uno",
//             descriptionEN: "service one description",
//             descriptionES: "service uno description"
//         },
...
//                     <ServiceCard
//                         key={t(service[`titleKey${language.toUpperCase()}`])}
//                         serviceTitle={t(service[`titleKey${language.toUpperCase()}`])}
//                         serviceDescription={t(service[`descriptionKey${language.toUpperCase()}`])}
//                     />
...
function Home() {
    ...
    const services = [
        {
            titleKeyEN: "service one title",
            titleKeyES: "servico title uno",
            descriptionKeyEN: "service one description",
            descriptionKeyES: "service uno description"
        },
    ...
    return (
        <section className="">
            ...
            <p>
            {t(services[0][`titleKey${language.toUpperCase()}`])}
            <T keyName={services[0][`titleKey${language.toUpperCase()}`]} />
            </p>
